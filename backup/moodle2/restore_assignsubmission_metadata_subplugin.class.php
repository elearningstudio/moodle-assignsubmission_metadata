...
class restore_assignsubmission_metadata_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_metadata'); // we used get_recommended_name() so this works
    ...
    /**
     * Processes one assignsubmission_metadata element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_metadata_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignsubmission_metadata', $data);

        $this->add_related_files('assignsubmission_metadata', 'submissions_metadata', 'submission', null, $oldsubmissionid);
    }
