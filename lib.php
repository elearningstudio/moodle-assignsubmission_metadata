 ...
 */
function assignsubmission_metadata_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $USER, $DB;
    ...
    $fullpath = "/{$context->id}/assignsubmission_metadata/$filearea/$itemid/$relativepath";
